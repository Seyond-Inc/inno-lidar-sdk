...
/*
 * @brief Set the callback data type of the InnoDataPacketCallback.
 * @param handle Lidar handle.
 * @param type The data type of the callbacks.
 * INNO_CALLBACK_SPHERE_PACKET: app will receive a packet of sphere points,default is INNO_CALLBACK_SPHERE_PACKET
 * INNO_CALLBACK_XYZ_PACKET: app will receive a packet of XYZ points

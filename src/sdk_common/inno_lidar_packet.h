...
enum InnCallbackDataType {
  INNO_CALLBACK_PACKET_TYPE_NONE = 0,
  // Sphere packet Callback
  INNO_CALLBACK_SPHERE_PACKET = 1,
  // XYZ packet Callback
  INNO_CALLBACK_XYZ_PACKET = 2,
  // XYZ_frame Callback
  INNO_CALLBACK_XYZ_FRAME = 3,
  INNO_CALLBACK_PACKET_TYPE_MAX = 4,
};
...
typedef DEFINE_INNO_COMPACT_STRUCT(InnoStatusInFaults) {
  /*
   *  Each bit represent one fault defined in fault table.
   *  different lidar type has different fault table.
   *  FalconK1 fault defined in enum InnoLidarInFault
